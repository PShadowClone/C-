...
namespace ManageStock {
    ...
    public partial class StockDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, int Amount, double Price) {
...
namespace ManageStock.StockDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Amount], [Price]) VALUES (@Id, @Name, @" +
                "Amount, @Price);\r\nSELECT Id, Name, Amount, Price FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Amount] = @Amount, [Price] = @Price WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price));
SELECT Id, Name, Amount, Price FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Amount, Price FROM dbo.[Table]";
        ...
        public virtual int Fill(StockDataSet.TableDataTable dataTable) {
        ...
        public virtual StockDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StockDataSet.TableDataTable dataTable = new StockDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StockDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Amount, double Original_Price) {
        ...
        public virtual int Insert(int Id, string Name, int Amount, double Price) {
        ...
        public virtual int Update(int Id, string Name, int Amount, double Price, int Original_Id, string Original_Name, int Original_Amount, double Original_Price) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Amount, double Price, int Original_Id, string Original_Name, int Original_Amount, double Original_Price) {
            return this.Update(Original_Id, Name, Amount, Price, Original_Id, Original_Name, Original_Amount, Original_Price);
        }
    }
