...
namespace ManageStock {
    ...
    public partial class StockDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/StockDataSet1.xsd";
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Name, int Amount, double Price, System.DateTime Date) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public double Price {
                get {
                    return ((double)(this[this.tableTable.PriceColumn]));
                }
                set {
...
namespace ManageStock.StockDataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price) AND ((@IsN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Amount], [Price], [Date]) VALUES (@Name, @Amo" +
                "unt, @Price, @Date);\r\nSELECT Id, Name, Amount, Price, Date FROM [Table] WHERE (I" +
                "d = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Name] = @Name, [Amount] = @Amount, [Price] = @Price, [Date] = @Date WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Amount] = @Original_Amount) AND ([Price] = @Original_Price) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT Id, Name, Amount, Price, Date FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ManageStock.Properties.Settings.Default.StockConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Amount, Price, Date FROM dbo.[Table]";
        ...
        public virtual int Fill(StockDataSet1.TableDataTable dataTable) {
        ...
        public virtual StockDataSet1.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StockDataSet1.TableDataTable dataTable = new StockDataSet1.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StockDataSet1.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Amount, double Original_Price, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string Name, int Amount, double Price, global::System.Nullable<global::System.DateTime> Date) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, int Amount, double Price, global::System.Nullable<global::System.DateTime> Date, int Original_Id, string Original_Name, int Original_Amount, double Original_Price, global::System.Nullable<global::System.DateTime> Original_Date, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Amount, double Price, global::System.Nullable<global::System.DateTime> Date, int Original_Id, string Original_Name, int Original_Amount, double Original_Price, global::System.Nullable<global::System.DateTime> Original_Date) {
            return this.Update(Name, Amount, Price, Date, Original_Id, Original_Name, Original_Amount, Original_Price, Original_Date, Original_Id);
        }
    }
